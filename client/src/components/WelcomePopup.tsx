    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-500">
      <div className="relative bg-gradient-to-br from-zinc-900 via-violet-900/30 to-black border-2 border-violet-500/50 rounded-3xl p-8 max-w-md mx-4 animate-in zoom-in-95 duration-700 shadow-2xl shadow-violet-500/25">
        ...
        <div className="text-center mb-6">
          <div className="relative inline-block">
            <img 
              src={mascotImage} 
              alt="$EEEEE Mascot" 
              className="w-32 h-32 mx-auto animate-bounce-slow drop-shadow-2xl"
            />
        ...
        <div className="text-center mb-8">
          <h2 className="font-anton text-3xl uppercase mb-4 bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">
            Welcome to $EEEEE!
          </h2>
        ...
        <div className="space-y-4">
          <button
            onClick={handleClose}
            className="w-full group relative px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 rounded-xl font-bold text-lg tracking-wide transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-violet-500/25 overflow-hidden"
          >
          ...
          <div className="flex gap-4">
            <a
              ...
              onClick={handleClose}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-xl font-semibold text-center hover:scale-105 transition-transform"
            >
              💰 Buy Now
            </a>
            <a
              ...
              rel="noopener noreferrer"
              onClick={handleClose}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl font-semibold text-center hover:scale-105 transition-transform"
            >
              💬 Join Discord
            </a>
          </div>
          ...
          <button
            onClick={toggleSound}
            className="w-full px-4 py-2 bg-zinc-800/50 hover:bg-zinc-700/50 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-3xl">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 bg-violet-400 rounded-full animate-float opacity-60"
              style={{
                left: `${20 + i * 15}%`,
                top: `${30 + i * 10}%`,
